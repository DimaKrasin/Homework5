...
public class Car {
    ...
    public void getWheelFromIndex(int index) {
        ...
        for(int i = 0; i < carWheels.length; i++){
            ...
            if (index == i) {
                x = carWheels[i].getWheelconditional();
            }
        }
    ...
    public double maxSpeedNow() {
        ...
        double maxEarse = carWheels[0].getWheelconditional();
        if (passngerNow == 0) maxSpeedNow = 0;
        else {
            for (int i = 0; i < carWheels.length; i++) {
                if (maxEarse > carWheels[i].getWheelconditional()) {
                    maxEarse = carWheels[i].getWheelconditional();
                }
            }
